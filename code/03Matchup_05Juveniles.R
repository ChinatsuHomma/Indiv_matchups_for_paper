...
if(saveFiles){
  write.csv(matchupList, "output/02matchupList/05MatchupListJuveniles.csv", row.names = FALSE)
}
...
if(saveFiles){
  write.csv(matchupTable, "output/03matchupTable/05MatchupTableJuveniles.csv", row.names = TRUE)
}
